...
export class PacienteEdicionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe((params: Params) => {
      ...
      //console.log("consolaso, el id es igual a: " +this.id);
      //console.log("consolaso, el edicion es igual a: " +this.edicion);
      this.initForm();
    });
  }
    ...
    if (this.edicion) {
      ...
      this.pacienteService.modificar(this.paciente).subscribe(data => {
        this.pacienteService.listar().subscribe(pacientes => {
          //Se vuelve a traer la data, con el cliente modificado y se le vuelve
          // a pasar la data 
