...
export class EspecialidadComponent implements OnInit {
  ...
  //Cuando es publico, es porque probablemente se lo debe usar en el html
  constructor(private especialidadService: EspecialidadService, public route: ActivatedRoute, 
